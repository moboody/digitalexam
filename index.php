...
echo " <h1>Login to Digital Exam System</h1> ";
echo "<body background=\"images/bubble.png\">";
echo " <form action=\"$self\" method=\"post\"><input type=\"password\" name=\"pass\"><input type=\"submit\" name=\"submit\" value=\"Login\"></form> </form></body>";
}
include ('footer.php');
?> 